                    ...
                    if ($resultadoEstoque == true) {
                      ...
                      <span class="input-group-text bg-muted">Deseja retirar do estoque?</span>
                          ...
                          <div class="custom-control custom-radio ">
                            ...
                            <input class="form-control-input " type="radio" name="estoque"  onclick="" id="sim" value="1" checked >
                          ...
                          <div class="custom-control custom-radio">
                            ...
                            <input class="form-control-input" type="radio" onclick="" name="estoque" id="nao" value="0" >
                       ...
                       <div class="input-group mb-3" id="local">
                         ...
                         <div class="input-group mb-3" id="">
                          ...
                          <input type="text" class="form-control" style="text-align:center;" placeholder="R$ - " name="valorpeca">
                        </div>
                        <div class="input-group mb-3" id="notaF">
                          <div class="input-group-prepend ">
                            <span class="input-group-text bg-muted" >Nota Fiscal:</span>
